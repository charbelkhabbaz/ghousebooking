...
<body class="bg-light">
  ...
  <!-- Section for Contact Us heading and description -->
  <div class="my-5 px-4">
  ...
  <!-- Main container for contact details and form -->
  <div class="container">
    <div class="row">
      <!-- Left side container for embedded map and contact details -->
      ...
      <!-- Right side container for message form -->
  ...
  <?php 
    // Handling form submission and storing the query in the database
    if(isset($_POST['send']))
    {
